...
The market could have changed by now. Things are always in flux, so gather your own evidence and experience. I had the rest results from referrals and from professional recruiters who reached out to me on LinkedIn. It took a little time, but eventually I was able to differentiate between professional, serious recruiters and the ones who work for contracting agencies who just want to fix you at a lowballed hourly rate, and then invariably ghost anyway.
...
* Algo/DS interview cheat sheet.  
* Frontend (vanilla JS) cheat sheet.
