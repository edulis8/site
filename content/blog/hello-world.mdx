---
title: Hello 🌎
description: My first blog post in a very long time.
date: 2024-04-28
tags: ["blog"]
published: true
---
...
I used another blogspot blog to to document my three month bike-touring trip through New Zealand.
...
Later, I used Wordpress to host two different business websites:
 - edulisgardens.com (now defunct): a site I built from scratch using some dynamic jQuery, Bootstrap styles and  cuttin edge tech like an auto-rotating image carousel 🫠. It also integrated with Instagram and had an online store to sell rare fruit.
